export function Footer() {
  ...
  const instruments = ["Guitar", "Keyboard", "Saxophone", "Drums"];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            <a href="#hero" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[15px] font-medium text-gray-900">Praise-G Music</span>
            </a>
            ...
            <div className="flex gap-2">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-[34px] h-[34px] border border-gray-200 rounded-lg flex items-center justify-center text-gray-400 hover:border-red-500 hover:text-red-600 transition-colors text-xs"
                >
                  {label[0]}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={text} className="flex items-start gap-2 text-[13px] text-gray-500">
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="text-[12px] text-gray-300">
            &copy; 2025 Praise-G Music. All rights reserved.
          </p>
